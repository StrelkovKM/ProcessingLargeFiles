...
int main () {
    FileProcessing processor("/home/misha/ProcessingLargeFiles/src/InputFile.txt", "/home/misha/ProcessingLargeFiles/src/OutputFile.txt");
    processor.SetSizeRAM(100 * 1024);
